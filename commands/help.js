...
module.exports = {
  name: 'help',
  description: 'يعرض قائمة الأوامر والفئات المتاحة.',
...
I operate under **𝐄𝐋¹ ᴢ ᴇ ᴛ丨ESPORTS**, built to serve your community efficiently.`)
      ...
      .setFooter({ text: 'The Bot works thanks to (160) Files of Code.', iconURL: message.client.user.displayAvatarURL() });
    ...
    collector.on('collect', async (interaction) => {
      ...
      } else if (interaction.values[0] === 'scrim') {
        embed = new EmbedBuilder()
          .setColor(0x6614B8)
          ...
          .addFields(
            ...
            { name: '・.result calculator ', value: '`حسب نقاط السكرم.`' },
          );
      }
